...
function GF256Poly(d, a) {
    ...
    this.divide = function(b) {
        ...
        for (var a = this.field.Zero, c = this, d = b.getCoefficient(b.Degree), d = this.field.inverse(d); c.Degree >= b.Degree&&!c.Zero;)
            var j = c.Degree - b.Degree, k = this.field.multiply(c.getCoefficient(c.Degree),
...
qrcode = {
    ...
    decode: function(d) {
        ...
        b.onload = function() {
            ...
            null != d && (d = d.getContext("2d"), d.clearRect(0, 0, 320, 240), drawImageIOSFix(d, b, 0, 0, 320, 240,0,0,300,250));
            a.width = b.width;
            a.height = b.height;
            drawImageIOSFix(c, b, 0, 0, a.width, a.height, 0, 0, b.width, b.height);
...
(function(d) {
    d.fn.html5_qrcode = function(a, c, b) {
        ...
        navigator.getUserMedia ? navigator.getUserMedia({
            video: !0
        }, e, b) : console.log("Camera streaming (HTML5 - getUserMedia) not supported in this browser.");
        qrcode.callback = a;
    }
})(jQuery);